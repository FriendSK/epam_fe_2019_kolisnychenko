...
export function renderTitle(post) {
...
function renderPost(post) {
  ...
  return ` <article>
                    ...
                    ${post.typeOfPost === 'audio' ? `<img class='post-img' src='${post.postImg ? post.postImg : 'img/Imgage_post2.png'}' alt='img' /> <audio controls src='#'></audio>` : ''}
                    <p>
                    ${post.descr}
                    </p>
