class Search {
  constructor() {
    this.searchForm = doc.getElementById('searchForm');
    this.searchForm.addEventListener('keyup', this.search);
    this.searchOutput = doc.querySelector('.header__search-result');
    this.resetBtn = doc.querySelector('.header__search-reset');
  ...
  showSearchResult(articles) {
    ...
    const searchInfo = doc.querySelector('.header__search-result');
